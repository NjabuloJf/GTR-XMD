...
const userName = 'NjabuloJf';
const token = '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';
const repoName = 'GTR-XMD';
...
ALIVE: `default`,
FOOTER: 'GTR-XMD BOT',
LOGO: `https://files.catbox.moe/reypkp.jpg` 
}
...
config.FOOTER = 'GTR-XMD-BOT'
config.LOGO = `https://files.catbox.moe/reypkp.jpg` 
config.ANTI_BAD = []
